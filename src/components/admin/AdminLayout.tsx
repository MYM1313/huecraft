...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8F9FA] text-luxury-ink font-sans selection:bg-luxury-gold/20 selection:text-luxury-gold">
              ...
              <>
                ...
                >
                  <div className="p-3 border-b border-luxury-border bg-luxury-ink/[0.02]">
                    <p className="text-[9px] font-bold uppercase tracking-widest text-luxury-ink">Signed in as</p>
                    <p className="text-[8px] text-luxury-gray truncate">{user?.email}</p>
                  </div>
                  <div className="p-1.5">
                    <button 
                      onClick={handleLogout}
          ...
          <div className="relative">
            ...
            >
              <div className="flex flex-col items-end">
                ...
                <span className="text-[9px] text-luxury-gray leading-none mt-0.5">{user?.email?.split('@')[0]}</span>
              </div>
      ...
      {/* Main Content */}
      <main className="flex-1 pt-16 pb-24 lg:pt-16 lg:pb-0 lg:ml-64">
